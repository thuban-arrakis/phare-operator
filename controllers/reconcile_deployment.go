...
func (r *PhareReconciler) reconcileDeployment(ctx context.Context, phare pharev1beta1.Phare) error {
	...
	if err != nil && errors.IsNotFound(err) {
		...
		diff := cmp.Diff(originalDeployment, existingDeployment, cmpopts.IgnoreFields(corev1.Container{}, "TerminationMessagePath", "TerminationMessagePolicy", "ImagePullPolicy")) // TODO: Ignore more fields? Anyways, it's should be in constants.
